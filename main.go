...
import (
	...
	"authentication-center/internal/routers"
	"authentication-center/pkg/cache"
	"authentication-center/pkg/db"
	"authentication-center/pkg/elastic"
	"authentication-center/pkg/idGenerator"
	"authentication-center/pkg/logger"
	"authentication-center/pkg/mq"
	"authentication-center/pkg/setting"
	"authentication-center/pkg/tracer"
...
// @version 1.0
// @description 统一认证平台
// @Github https://github.com/superToolsCollection/authentication-center
func main() {
